    ...
    <div>
      ...
      <div className="hero min-h-[70vh]">
        <div className="hero-content flex-col-reverse md:flex-row-reverse">
          ...
          />
          <div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl mb-3 text-center md:text-left text-gray-700 font-bold"> Ultimate Task Management Solution
              <br />
              For <span><ReactRotatingText items={["Web Developer", "Programmer", "Students", "Designers", "Entrepreneurs"]} /></span>

            </h1>
            <div className="text-center md:text-left">
              <button onClick={() => router.push("/signIn")} className=" btn btn-primary text-white">Get Started</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="mb-10">
          <div className="divider divider-primary ">
            <p className=" text-lg md:text-4xl text-gray-700 font-bold text-center ">
              How Task Management App Benefit Users
            </p>
          </div>
          ...
          <div>
            ...
            <div className=" flex flex-col md:flex-row justify-evenly items-center gap-3">
              ...
              <div className=" p-4 font-medium text-gray-600 md:max-w-96 lg:max-w-screen-sm ">
                ...
                <br /> One of the primary benefits of Task Manager is the ability to organize your tasks efficiently. With intuitive interfaces and customizable features, these platforms allow you to create task lists, set deadlines, and prioritize assignments with ease. Say goodbye to scattered sticky notes. Task Manager provide a centralized hub for all your tasks and projects, ensuring nothing slips through the cracks.
              </div>
            </div>
            {/* Time Management */}
