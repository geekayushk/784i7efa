                        ...
                        <div className="flex flex-col items-center justify-between xl:flex-row">
                            <div className=" hidden md:block w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                                ...
                                <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                                    At Task Manager, we understand the importance of efficient task management in achieving your goals and maximizing productivity. Our platform offers a comprehensive set of features designed to streamline your workflow and empower you to conquer your tasks with ease. Whether you&amp;re managing personal projects, collaborating with a team, or overseeing complex initiatives, Task Manager has everything you need to stay organized and focused.
                                </p>
                            </div>
