            ...
            <div className="navbar  shadow-md ">
                <div className='navbar  w-full max-w-7xl mx-auto '>
                    ...
                    <div className=" navbar-start">
                        ...
                        <p className="hidden md:block btn btn-ghost text-xl pt-2.5 ">Task Manager</p>
                    </div>
                    <p className="block md:hidden btn btn-ghost text-xl pt-2.5 ">Task Manager</p>
                    ...
                    </div>
                    {
                        user ?
                            ...
                            <>
                                <div className="navbar-end">
                                    <Link href={"/signIn"} className="btn btn-outline hover:bg-[#4bb14bdc] hover:border-0  btn-sm">Login </Link>
                                </div>
                            </>
                    }
                </div>
